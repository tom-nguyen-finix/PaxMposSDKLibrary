...
@return  @link PaxEasyLinkRetCode @/link
*/
-(PaxEasyLinkRetCode) rkiRemoteKeyDownload:(NSString *)hostUrl hostPort:(NSString *)hostPort statusMessageBlock:(onStatusMessageCB)showStatusCB;
...
@return  @link PaxEasyLinkRetCode @/link
*/
-(PaxEasyLinkRetCode) rkiUnBindDevice:(NSString *)hostUrl hostPort:(NSString *)hostPort statusMessageBlock:(onStatusMessageCB)showStatusCB;
...
//@param type     M1 Card key type<br/>
//    {@link EM1KeyType#TYPE_A} - Password A is submitted
//    {@link EM1KeyType#TYPE_B} - Password B is submitted
...
//@return  @linkPaxEasyLinkRetCode @/link
//*/
//-(PaxEasyLinkRetCode) piccM1Authority:(EM1KeyType)type blockNo:(Byte)blockNo password:(NSMutableArray *)pwd serialNo:(NSMutableArray *)serialNo;
...
//@return  @linkPaxEasyLinkRetCode @/link
//*/
//-(PaxEasyLinkRetCode) piccM1ReadBlock:(Byte)blockNo outBlockValue:(NSMutableArray *)outBlockValue;
...
//    1. If the block number of BlkNo and UpdateBlkNo are the same, use {@link EM1OperateType#INCREMENT} or {@link EM1OperateType#DECREMENT} to increase or decrease value of block number.<br/>
//    2. If the block numbers are different, when use {@link EM1OperateType#INCREMENT} or {@link EM1OperateType#DECREMENT}, the value stored in BlkNo will have no changes,<br/>
//    and the value of UpdateBlkNo block is equal to the increased or decreased value of BlkNo.
//    3. If doing the {@link EM1OperateType#BACKUP} operation, the value is invalid, then stored the value of BlkNo to UpdateNo.<br/>
//    The block numbers which referred in this function must be Chunk, BlkNo and UpdateBlkNo must be in the same sector.
//@param blockNo       Specifies visiting block number.
...
//@return  @linkPaxEasyLinkRetCode @/link
//*/
//-(PaxEasyLinkRetCode) piccM1Operate:(EM1OperateType)operateType blockNo:(Byte)blockNo blockValue:(NSMutableArray *)blockValue updateBlockNo:(Byte)updateBlockNo;
...
//@return  @linkPaxEasyLinkRetCode @/link
//*/
//-(PaxEasyLinkRetCode) piccLight:(NSData *)ledindex ledStatus:(ELedStatus)ledStatus;
//
///*!
